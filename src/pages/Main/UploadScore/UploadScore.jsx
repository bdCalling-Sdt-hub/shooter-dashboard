    ...
    return (
        ...
        <div className="mt-[44px] cursor-pointer text-white flex items-center pb-3 gap-2">
          <MdOutlineKeyboardArrowLeft
            ...
            size={34}
          />
          <h1 className="text-[24px] text-primary font-semibold">Upload Match Score</h1>
        </div>
        <div>
          <Form
            name="basic"
          ...
          >
            ...
            <div className="flex gap-5">
                  ...
                  <input className="p-4 bg-[#FFE7EA4F]
              rounded w-full 
              justify-start 
              border-none
              mt-[12px]
              text-white
              items-center 
              gap-4 inline-flex outline-none focus:border-none" type="file" onChange={handleFileChange} accept=".csv" required />
