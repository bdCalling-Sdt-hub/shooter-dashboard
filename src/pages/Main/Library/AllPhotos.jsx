          ...
          <p>Add Photos</p>
            ...
            <div className='grid grid-cols-4 gap-4'>
            {
                result?.map((item,index)=>{
                    return <div key={index} className='border-2 rounded-md  border-[#FA1131] p-3'>
                        <div className=''>
                        <img className='h-[90%]' key={index} src={`${import.meta.env.VITE_BASE_URL}${item?.image?.publicFileURL}`} alt="" />
                        </div>
                        ...
                        <div className='lg:flex gap-2 my-3 '>
                            ...
                            <p onClick={()=>handleDelete(item?._id)} className='flex-1 cursor-pointer mt-2 text-center rounded-md text-white bg-[#FA1131] px-10 py-2'>Delete</p>
                        </div>
                        </div>
                })
            }
