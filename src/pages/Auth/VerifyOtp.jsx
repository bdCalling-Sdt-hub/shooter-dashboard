  ...
  const handleMatchOtp = async ()=>{
    ...
    return (
      ...
      <div className="flex gap-[120px]">
        ...
        <p className=" text-16 text-white mt-[24px] mb-[32px]">We'll send a verification code to your email. Check your inbox and enter the code here.</p>
        <div className="space-y-7 fit-content object-contain">
          ...
          {/* <div className="flex justify-between w-[500px]">
            ...
            <p
              onClick={handleReset}
              className="cursor-pointer text-[red] text-[16px] font-medium"
            >
              Resend
            </p>
          </div> */}

          <button  onClick={handleMatchOtp}  className="block w-[500px] h-[56px] px-2 py-4 mt-2 text-white bg-gradient-to-r from-red-500 to-red-800 rounded-lg hover:bg-red-600">
            Verify
          </button>
        </div>
       </div>
