...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center rounded-md mb-[24px] p-[16px] bg-[#281F1F]">
      <div className="flex items-center gap-5">
        <MdMenu className="h-[42px] w-[42px] text-[#FA1131]" />
      ...
      <div className="flex gap-5">
        ...
        >
          <FaRegUser className="text-[#FA1131] border-2 border-[#FA1131] rounded-full p-2 w-[52px] h-[52px]" />
        </div>
      </div>
    </div>
  );
